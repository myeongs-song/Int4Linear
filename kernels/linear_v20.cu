#ifndef _CUSTOM_INT4_LINEAR_CU_V20
#define _CUSTOM_INT4_LINEAR_CU_V20

#include <cuda.h>
#include <stdio.h>

#include "linear_v20.h"

void linear_v20_launch(
    void *x_packed_d, void *w_packed_d, void *y_d, int m, int n, int k
) {
    using config = LinearConfig<8, 7, 7, 6, 6, 4>;

    cudaFuncSetAttribute(
        linear_v20_kernel<config>,
    ...
    linear_v20_kernel<config><<<gridDim, blockDim, kSmemSize>>>(args);
